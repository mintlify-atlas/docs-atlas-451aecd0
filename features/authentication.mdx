...
Users don't create accounts, so they need anonymous identities. Usernames are generated client-side:
...
- Not validated server-side (sender validation only checks max length)
- Displayed in the UI to differentiate "YOU" from other participants
